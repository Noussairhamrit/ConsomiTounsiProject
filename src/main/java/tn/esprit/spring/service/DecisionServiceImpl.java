...
public class DecisionServiceImpl implements IDecisionService {
	...
	@Autowired
	public DecisionServiceImpl(JavaMailSender javaMailSender) {
	...
	public void affecterDecisionAReclamation(int id_deci, int id_recl) {
		...
		reclamationManagedEntity.setDecision(decisionManagedEntity);
		reclamationRepository.save(reclamationManagedEntity);
	...
	public void affecterDecision1AReclamation(int id_deci, int id_recl) throws MailException, MessagingException {
		...
		buf.append("\"<html>\n" + "  <head>\n" + "    <meta name=\"viewport\" content=\"width=device-width\" />\n"
				...
				+ "                        <p>dear customer after your reclamation about your product we decide to do an ,"
				+ reclamationManagedEntity.getDecision().getTypedecision() + " "
		...
		helper.setTo(reclamationManagedEntity.getCommandes().getClient().getEmail());
		System.out.println("jjjjjjjjj " + reclamationManagedEntity.getCommandes().getClient().getEmail());
		helper.setFrom("consommi.toounsi.619@gmail.com");
		helper.setSubject("Consomi tounsi decision");
		helper.setText(messaage, messaage);

		/////////////// reclamationManagedEntity.getCommandes().getClient().getEmail()

		// mail.setTo(reclamationManagedEntity.getCommandes().getClient().getEmail());
		//
		// mail.setFrom("consommi.toounsi.619@gmail.com");
		// mail.setSubject("Consomi tounsi decision");
		// mail.setText("dear customer after your reclamation about your product
		// we decide to do an "
		// +reclamationManagedEntity.getDecision().getTypedecision());
