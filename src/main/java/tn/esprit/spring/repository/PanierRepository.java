...
public interface PanierRepository extends JpaRepository<Panier , Integer> {
	...
	@Query(value = "SELECT  NEW tn.esprit.spring.entity.lignecommandeproduit(p.nom,l.quantite,p.prix,l.quantite*p.prix) FROM Panier l join l.commande c  join l.produit p   WHERE c.client.id=:idc and c.status='en cours'")
